...
const AddBloodIssue = () => {
  ...
  if (bloodcomponents && formData.BloodComponent !== " ") {
    ...
    const findamount = bloodcomponents.find(
      (p) => p.id === Number(formData.BloodComponent)
    );
    ...
    await doPost({
      doi:
        formData.doi === ""
          ...
          : Number(formData.doi.split("-").join("")),
      patientName: formData.PatientName,
      amount:
        formData.paymentmode === "Paid" ? Number(componentsprice) : Number(0),
    ...
    <>
      ...
      >
        ...
        <div className=" p-5 container" style={{minHeight:"80vh"}}>
          <div>
            <h1 className="Heading">Blood Issue</h1>
          </div>
