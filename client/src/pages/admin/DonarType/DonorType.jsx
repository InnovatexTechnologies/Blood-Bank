...
const DonorType = () => {
  const {
    ...
    error,
    doFetch,
  } = useGetApi("/api/DonorType");
  const {
    data: deletedata,
    isLoading: deleteloading,
    error: deleteerror,
    doDelete,
  } = useDeleteApi("/api/DonorType");
    ...
    <>
      ...
      >
        ...
        <div className=" p-5 container" style={{minHeight:"80vh"}}>
          <div>
            <Link className="btn  mybtn " to="/admin/add-DonorType">
              Add DonorType
            </Link>
          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button
                          ...
                          onClick={async(e) => {
                            await doDelete(`/api/DonorType/${c.id}`);
                            await doFetch(`/api/DonorType`);
                          }}
                        >
                          <AiTwotoneDelete />
                        </button>
