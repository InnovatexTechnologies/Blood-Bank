    ...
    <>
      ...
      >
        ...
        <div className=" p-5 container" style={{minHeight:"80vh"}}>
          <div>
            <Link className="btn  mybtn " to="/admin/add-Organization">
              Add Organization
            </Link>
          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <Link
                          ...
                          to={`/admin/edit-Organization/${c.id}`}
                        >
                          {" "}
                          <FiEdit2 />{" "}
                        </Link>
                        <button
                          ...
                          onClick={(e) => {
                            doDelete(`/api/organization/${c.id}`);
                            doFetch(`/api/organization`);
                          }}
                        >
                          <AiTwotoneDelete />
                        </button>
